...
Das Programm wird mittelsder Objektorientierten Sprache ActionScript 3 (AS3) und dem Flex SDK in der Eclipse Entwicklungsumgebung Programmiert. Das Programm ist dank dem Flashplayer auf fast jedem Betriebssystem und Browser lauffähig.
...
Aus den trigonometrischen Gleichungen werden die erste und zweite Ableitung gebildet.
...
Die Kräfte werden pro Pendel berechnet und in einzelne Gleichungen gesetzt. Auf Grundlage des zweiten newtonschen Gesetzes $(F = m \cdot a)$ wurden folgende Gleichungen für das Pendel erstellt:
...
\begin{figure}[H]
	\begin{minipage}[!b]{0.5\textwidth}
		...
		\caption{Kräfte im oberen Pendel}
		\label{fig:force}
	\end{minipage}
	\begin{minipage}[!t]{\textwidth}
		\vspace{0pt}\raggedright
