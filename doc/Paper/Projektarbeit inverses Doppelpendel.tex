...
Als Entwicklungsumgebung wird FDT (Flash Development Tool) \citep{fdt} eingesetzt. FDT stellt für die Entwicklung von AS3 und Flex-Projekten nützliche Funktionen wie Fehlererkennung, Debugger und Autocomplete zur Verfügung.
...
\begin{figure}[H]
	...
	\caption{Realisierte grafische Oberfläche}
	\label{fig:xml}
\end{figure}
